...
public class About extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View about = new AboutPage(this)
                ...
                .setDescription("DUMMY PROJECT CREATED BY \n  NIHAL VAIDYA \n  FOR FINAL YEAR B.SC. COMPUTER SCIENCE")
                .addItem(new Element().setTitle("VERSION 0.8"))
                .addItem(addsElement)
                .addGroup("CONNECT WITH US ")
                .addEmail("nhlvcam@gmail.com")
                .addWebsite("http://www.nihalvaidya123.com")
//                .addFacebook("Naresh Vaidya ")
                .addTwitter("nhlvcam")
                .addYoutube("UCRZ7xBsehvpfquJtWpvSY1w")
                .addPlayStore("a123.vaidya.nihal.foodcrunchserver")
